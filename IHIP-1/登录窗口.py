...
# 第2步，给窗口的可视化起名字
window.title('智能健身指导器')
 
# 第3步，设定窗口的大小(长 * 宽)
window.geometry('400x200')  
 
# 第4步，加载欢迎标题
l = tk.Label(window, text='欢迎您使用智能健身指导器！', font=('宋体', 12), width=30, height=3).place(x=30,y=10)

# 第5步，用户信息
tk.Label(window, text='User name:', font=('Arial', 14)).place(x=10, y=70)
tk.Label(window, text='Password:', font=('Arial', 14)).place(x=10, y=110)
...
entry_usr_name.place(x=120,y=75)
# 用户密码
var_usr_pwd = tk.StringVar()
entry_usr_pwd = tk.Entry(window, textvariable=var_usr_pwd, font=('Arial', 14), show='*')
entry_usr_pwd.place(x=120,y=115)
...
def usr_sign_up():
    ...
    # 下面的 sign_to_train
    btn_comfirm_sign_up = tk.Button(window_sign_up, text='Sign up', command=sign_to_train)
